...
def find_articles():
    ...
    identifier = ['post', 'article', 'entry', 'news', 'heading', 'header'] # words that appear often in html attribute descriptions for posts 
    ...
    overall = [] # list will contain the final result, namely a list of news article names and links to those news articles
